...
class NetBusinessRatingURLCrawler(Spider):
    ...
    def crawl(self, response):
        ...
        url = response.xpath("//div[@id='content']/fieldset[@class='form']/div/a/@href").extract()
        servicelist = response.xpath("//div[@id='content']/fieldset[@class='form']/div/a/text()").extract()
